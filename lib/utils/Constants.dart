...
const GOOGLE_MAP_API_KEY = 'ADD GOOGLE MAP API KEY';
//endregion

//region MQTT port and unique name
final client = MqttServerClient.withPort("broker.hivemq.com", "", 1883);
const MQTT_UNIQUE_TOPIC_NAME = 'ADD YOUR MQTT UNIQUE TOPIC NAME'; // Don't add underscore at the end of the name
//endregion
